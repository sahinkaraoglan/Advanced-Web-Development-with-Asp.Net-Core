...
namespace IdentityApp.Controllers
{
    public class AccountController:Controller
    {
        ...
        public async Task<IActionResult> Create(CreateViewModel model)
        {
            if(ModelState.IsValid)
            {
                ...
                if(result.Succeeded)
                {
                    ...
                    "Hesap Onayı", 
                    $"Lütfen email hesabınızı onaylamak için linke <a href='http://localhost:5294{url}'>tıklayınız.</a>");

                    TempData["message"] = "Email hesabınızdaki onay malini tıklayınız.";
        ...
        public async Task<IActionResult> ForgotPassword(string Email)
        {
            ...
            await _emailSender.SendEmailAsync(Email, "Parola Sıfırlama", $"Parolanızı yenilemek için linke <a href='http://localhost:5294{url}'>tıklayınız.</a>.");
